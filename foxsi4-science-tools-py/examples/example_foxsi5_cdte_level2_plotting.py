...
check_dir = "/Users/kris/Documents/umnPostdoc/projects/both/foxsi5/data/"
...
for _c, cdte_no in enumerate([1, 3, 4, 5]):
    # load in the level 2 file
    cdte_hdul = load_fits(check_dir+level2s[_c])
    ...
    ti_obs_start, ti_obs_end = cdte_hdul[0].header["TI3"], cdte_hdul[0].header["TI4"]
